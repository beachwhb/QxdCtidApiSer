...
using QxdCtidApiSer.Sessions;
using QxdCtidApiSer.Web.Controllers.Results;
using QxdCtidApiSer.Web.Models;
using QxdCtidApiSer.Web.Models.Account;
...
{
    public class AccountController : QxdCtidApiSerControllerBase
    {
