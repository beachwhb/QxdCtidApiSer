...
namespace QxdCtidApiSer.Web
{
    ...
    /// </summary>
    public class QxdCtidApiSerNavigationProvider : NavigationProvider
    {
        public override void SetNavigation(INavigationProviderContext context)
        {
            context.Manager.MainMenu
                .AddItem(new MenuItemDefinition(PageNames.Home, L("HomePage"), url: "", icon: "home", requiresAuthentication: true))
                .AddItem(new MenuItemDefinition(PageNames.Ctids, L("Ctids"), url: "Ctids", icon: "business", requiredPermissionName: PermissionNames.Pages_Tenants))
                ...
                .AddItem(new MenuItemDefinition("MultiLevelMenu", L("MultiLevelMenu"), icon: "menu")
        ...
        {
            return new LocalizableString(name, QxdCtidApiSerConsts.LocalizationSourceName);
        }
    }
}
